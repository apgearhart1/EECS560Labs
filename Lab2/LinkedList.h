...
public:
  ...
  **/
  ~LinkedList();
  /* @pre none
  * @post checks to see if an entry is in an array
  * @param entry - entry of the array
  * @param arr - array being checked
  * @throw none
  **/
  bool inArr(int* arr, int entry);
  /* @pre none
  * @post removes all duplicates in the linked list
  * @param size - size of the current linked list
  * @throw none
  **/
